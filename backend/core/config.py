...
class Config:
    ...
    def _load_from_env(self):
        ...
        self.rag.knowledge_base_path = os.getenv(
            "RAG_KNOWLEDGE_BASE_PATH", self.rag.knowledge_base_path
        )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "openai": {"model": self.openai.model, "base_url": self.openai.base_url},
            "rag": {
