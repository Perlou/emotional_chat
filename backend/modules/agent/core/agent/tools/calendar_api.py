...
class CalendarAPI:
    ...
    def update_event(
        self, user_id: str, event_id: str, updates: Dict[str, Any]
    ...
    def suggest_time_slot(self, user_id: str, date: str, duration: int = 60) -> List[str]:
        """
        建议可用时间段
        ...
        """
        # 获取当天事件
        day_events = [e for e in self.events_db.get(user_id, []) if e["date"] == date]
