...
class PsychologyDB:
    ...
    def search_resources(
        ...
        for res_type in search_types:
            for resource in self.resources[res_type]:
                ...
                results.append({**resource, "resource_type": res_type})

        return results

    def get_recommendation(
        self, user_situation: str, emotion: str, resource_type: Optional[str] = None
    ) -> List[Dict[str, Any]]:
        """
        根据用户情况推荐资源
        ...
        # 搜索相关资源
        results = self.search_resources(category=category, resource_type=resource_type)
    ...
    def get_exercise_plan(self, goal: str, duration: int = 7) -> Dict[str, Any]:
        """
        获取练习计划
    ...
    def _generate_schedule(
        self, exercises: List[Dict[str, Any]], duration: int
    ) -> List[Dict[str, Any]]:
        """生成练习时间表"""
        ...
        for day in range(duration):
            ...
            day_schedule = {"date": date.strftime("%Y-%m-%d"), "day": day + 1, "exercises": []}
