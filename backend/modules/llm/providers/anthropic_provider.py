...
from ..models.llm_models import LLMResponse, CompletionResponse, ChatMessage, LLMUsage, LLMProvider
...
class AnthropicProvider(BaseLLMProvider):
        ...
        **kwargs,
        ...
        try:
            ...
            return LLMResponse(
                ...
                metadata={"id": response.id, "type": response.type, "role": response.role},
            )
    ...
    async def text_completion(
        self, prompt: str, model: str, temperature: float = 0.7, max_tokens: int = 1000, **kwargs
    ) -> CompletionResponse:
        """
