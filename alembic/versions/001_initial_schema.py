...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_emotion_analysis_session_id"), "emotion_analysis", ["session_id"], unique=False
    )
    op.create_index(
        op.f("ix_emotion_analysis_user_id"), "emotion_analysis", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_feedback_message_id"), "user_feedback", ["message_id"], unique=False
    )
